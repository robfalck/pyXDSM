...
% Group background colors (matching GUI colors)
\definecolor{groupblue}{HTML}{C8DCF0}
\definecolor{groupgreen}{HTML}{C8F0DC}
\definecolor{grouppurple}{HTML}{F0DCF0}
\definecolor{groupgold}{HTML}{F0E6C8}

% Group background styles
\tikzstyle{GroupBackground0} = [rounded corners=12pt, draw=groupblue!35, fill=groupblue!12, line width=2pt, dashed, dash pattern=on 4pt off 4pt, inner sep=12pt]
\tikzstyle{GroupBackground1} = [rounded corners=12pt, draw=groupgreen!35, fill=groupgreen!12, line width=2pt, dashed, dash pattern=on 4pt off 4pt, inner sep=12pt]
\tikzstyle{GroupBackground2} = [rounded corners=12pt, draw=grouppurple!35, fill=grouppurple!12, line width=2pt, dashed, dash pattern=on 4pt off 4pt, inner sep=12pt]
\tikzstyle{GroupBackground3} = [rounded corners=12pt, draw=groupgold!35, fill=groupgold!12, line width=2pt, dashed, dash pattern=on 4pt off 4pt, inner sep=12pt]
...
\pgfsetlayers{groups,data,process,main}
